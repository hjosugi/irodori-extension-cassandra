//! Native connector ABI for Cassandra.
//!
...
const HEALTH_RESPONSE_JSON: &str =
    r#"{"ok":true,"engine":"cassandra","abiVersion":1,"driverLinked":false}"#;
const DESCRIBE_RESPONSE_JSON: &str = concat!(
    r#"{"ok":true,"engine":"cassandra","abiVersion":1,"driverLinked":false,"manifest":"#,
